  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      "/note/": [
        ...
        {
          title: "NPM",
          children: ["NPM/npm基础", "NPM/npm机制", "NPM/npm包开发", "NPM/yarn"]
        },
        {
          title: "小程序",
          children: ["applet/taro"]
        },
        {
      ...
      "/advanced/": [
        ...
        {
          title: "React 源码分析",
          children: ["react源码分析/", "react源码分析/ReactDOM.render过程"]
        },
        {
          title: "Webpack",
          children: ["webpack/", "webpack/config", "webpack/optimization"]
        },
        "构建脚手架"
      ],
      // 后端
      "/backend/": ["", "node基础", "服务性能调优", "mongodb"],
      // 服务器相关
      "/services/": [
        "",
        {
